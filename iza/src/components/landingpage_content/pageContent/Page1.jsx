...
import very_small_device from '../../../assets/very_small_device.png'
import ssm_img from '../../../assets/ssm_img.png'
import sm_img from '../../../assets/sm_img.png'
import md_img from '../../../assets/md_img.png'
import Landingpageone from '../../../assets/Landingpageone.png'
import lg_img from '../../../assets/lg_img.png'
import './styles.css' //

const Page1 = ({ isVisible }) => {
  return (
    <div>
      {/* vlg device */}
      <img
      ...
      <div
        className=' justify-center items-center w-[400px] h-[50px] absolute rotate-90 text-[#ffff] lg:top-[200px]  lg:left-[100px]  md:top-[250px]  md:left-[-20px]  sm:top-[200px] sm:left-[-50px]  vvsm:top-[200px] vvsm:left-[-150px]  vsm:top-[250px] vsm:left-[-130px] ssm:left-[-130px] sm:text-[70px] vsm:text-[50px] vvsm:text-[40px] playfair'
      >
        ELISE X GAL
      </div>
    </div>
